...
@app.command("sync")
def sync(  # ruff: ignore[too-many-arguments]
    ctx: typer.Context,
    *,
...
def gitea_sync_deprecated(  # ruff: ignore[too-many-arguments]
    ctx: typer.Context,
    *,
    gitea_repo: gitea_repo_arg = "products/SLFO",
    allow_build_failures: Annotated[
