...
class OpenQAInterface:
    ...
    def __bool__(self) -> bool:
        ...
        """
        return self.url.netloc == settings.main_openqa_domain
    ...
    def is_devel_group(self, groupid: int) -> bool:
        ...
        return ret[0]["parent_id"] == settings.development_parent_group_id if ret else True  # ID of Development Group
