...
def test_was_older_job_ok_invalid_date(job: dict, log_message: str, caplog: pytest.LogCaptureFixture) -> None:
    approver_instance = Approver(args)
