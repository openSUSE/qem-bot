...
class MyIncident_2(MyIncident_1):
    ...
    def revisions_with_fallback(self, arch, version) -> bool:
        return True


def test_incidents_call_with_channels(request_mock) -> None:
    test_config = {}
    test_config["FLAVOR"] = {"AAA": {"archs": [""], "issues": {"1234": ":"}}}
...
class MyIncident_3(MyIncident_2):
    ...
    def contains_package(self, requires) -> bool:
        return True


def test_incidents_call_with_packages(request_mock) -> None:
    test_config = {}
...
def test_incidents_call_with_params_expand(request_mock) -> None:
...
def test_incidents_call_with_params_expand_distri_version(request_mock) -> None:
...
def test_incidents_call_with_params_expand_isolated(request_mock) -> None:
    """Product configuration has 4 settings.
...
def test_incidents_call_public_cloud_pint_query(request_mock, monkeypatch) -> None:
    test_config = {}
    test_config["FLAVOR"] = {"AAA": {"archs": [""], "issues": {"1234": ":"}}}
